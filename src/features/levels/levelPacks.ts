...
import { buildGeneratedRealNounLevels } from './generatedNonRussianLevels';
...
function buildStarterLevels(): Level[] {
  const levels = buildGeneratedRealNounLevels().sort((a, b) => a.language.localeCompare(b.language) || a.id - b.id);
