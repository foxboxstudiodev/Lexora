...
export function LanguagesScreen({ language, onLanguageChange, onBack }: LanguagesScreenProps) {
  ...
  return (
    <section className="screen-panel" aria-labelledby="languages-title">
      <div className="screen-header">
        ...
        <button className="icon-button" onClick={onBack} aria-label={labels.back}>
          ←
        </button>
      </div>
