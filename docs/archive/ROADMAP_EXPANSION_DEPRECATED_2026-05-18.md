# Deprecated Lexora Expansion Roadmap

Status: archived/deprecated.

This document is preserved only for historical reference. It is no longer the active project source of truth.

Active project source of truth: `docs/LEXORA_MASTER_PLAN.md`.
